...
- **Matt's background**: DeFi/AI builder in kr8tiv-ai org; ships on Bags.fm; already trades MEXC live; runs Solana (Phantom/Solflare) + Ethereum (MetaMask) wallets on-chain.
- **Hardware**: Windows 11 primary, Hostinger VPS as backup, occasional laptop use (must resume cleanly after sleep).
